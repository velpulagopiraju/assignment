...
class StudentMarksModel(models.Model):
    student = models.ForeignKey(StudentMainModel,on_delete=models.CASCADE,primary_key=True)
...
class studentMarksMainModel(models.Model):
    student = models.OneToOneField(StudentMainModel,on_delete=models.CASCADE,default='')
